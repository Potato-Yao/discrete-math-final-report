...
\BITSetup{
  ...
  info = {
    ...
    % 如需要换行，则用 “\\” 符号分割。
    title = 从代数结构与数论看公钥加密：RSA算法的数学解构,
    titleEn = {Public-Key Encryption through Algebraic Structures and Number Theory: A Mathematical Deconstruction of RSA},
    school = School of Computer Science,
    %major = Bachelor of Science in Mechanical Engineering,
    author = Feng Kaiyu,
    studentId = 11xxxxxxxx,
    supervisor = Jianwu Li,
    keywords = {离散数学, 代数结构, 数论, RSA 算法, 复杂度分析},
    keywordsEn = {Discrete Mathematics, Algebraic Structures, Number Theory, RSA Algorithm, Complexity Analysis},
