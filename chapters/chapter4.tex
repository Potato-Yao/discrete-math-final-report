...
($\mathbb{Z}_n^*$) and
Fermat's Little Theorem established in the previous chapter,
...
The process generates a public key (distributed openly) and a private key (kept secret)\cite{RSA}.
